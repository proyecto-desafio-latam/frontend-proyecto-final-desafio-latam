...
const BookDetail = () => {
    ...
    // take the object from the array of books and find the book with the id
    ...
    return (
        <div className="container mt-5 p-5">
            {
                <div className="card mb-3 mt-5" key={findBook.id}>
                    <div className="row g-0">
                        <div className="col-md-4 ">
                            <div className="img-container">
                                <img src={findBook.image} className="img-fluid rounded-start h-100" alt="..." />
                            </div>
                        </div>
                        <div className="col-md-8">
                            <div className="card-body">
                                <h5 className="fs-1">{findBook.title}</h5>
                                <p className="card-text"><b> Autor:</b> {findBook.author.name}</p>
                                <h4 className="card-text">
                                    <b> {FormatCoin(findBook.price)}</b>
                                </h4>
                                <p>Stock Disponible: {findBook.stock}</p>
                                <div className="d-flex justify-content-end gap-3">
